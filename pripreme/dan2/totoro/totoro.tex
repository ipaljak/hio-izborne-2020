...
U prvom su retku prirodni brojevi $K$ i $N$ $(1 \le K \le 10, 1 \le N \le 1000)$
iz teksta zadatka.
...
\sampleinputs{test/perm.dummy.in.1}{test/perm.dummy.out.1} &
\sampleinputs{test/perm.dummy.in.2}{test/perm.dummy.out.2} &
\sampleinputs{test/perm.dummy.in.3}{test/perm.dummy.out.3}
\end{tabularx}
